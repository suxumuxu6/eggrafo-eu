  ...
  const getSEOData = () => {
    if (searchQuery) {
      return {
        ...
        keywords: `${searchQuery}, ΓΕΜΗ έγγραφα, παραδείγματα εγγράφων, τροποποιήσεις εταιρειών, αναζήτηση εγγράφων`,
      };
    }
    ...
    return {
      ...
      keywords: "ΓΕΜΗ, έγγραφα ΓΕΜΗ, παραδείγματα εγγράφων, τροποποιήσεις εταιρειών, νόμοι εταιρειών, αιτήσεις ΓΕΜΗ, επιχειρηματικά έγγραφα, πρότυπα καταστατικά, ΓΕΜΗ Ελλάδα, επιχειρήσεις Αθήνα",
    };
  };
