    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-12 text-center">
          <h1 className="text-3xl font-bold mb-4 text-kb-darkgray">Document Repository</h1>
          <p className="text-gray-600 max-w-2xl mx-auto mb-8">
            Search through our knowledge base of PDF documents to find the information you need.
          </p>
